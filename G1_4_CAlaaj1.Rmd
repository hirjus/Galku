...
#head(test6)
#str(test6$maa2)
#taulu41 <- ISSP2012esim1.dat %>% tableX(maa,maa2,type = "count") - tarkistus uudelle muuttujan luontikoodille
...
```{r G1_4_ga, eval=FALSE, include=FALSE}
...
**zxy** On kiinnostava, mutta aika yksiuloitteinen (87 prosenttia ensimmäisellä dimensiolla). **pisteet voisi yhdistää?**
