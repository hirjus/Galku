...
osuuksien/koostumusdatan (compositional DA) analyysiin: ca ei ole "subcompositionally
coherent".
...
```{r suppoint-rprof1, fig.cap=Saksan ja Belgian alueet}
