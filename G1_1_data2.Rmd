...
**edit 30.1.20** Siivotaan, luodaan faktori-muuttujat heti alussa koko datalle.
...
#str(ISSP2012jh1c.data) # 32823 obs. of  23 variables
ISSP2012jh1c.data %>% summary()

```

Metatietojen (3)  ja maa-muuttujien (3) lisäksi aineistossa on seitsemäntoista muuttujaa. Yhdeksän muuttujaa ovat ns. substanssikysymysten vastauksia, joilla luodataan asenteita sukupuolirooleihin ja perhearvoihin. Kahdeksan taustamuuttujaa.
...
Koko aineistossa (valitut 25 maata) kysymyksen Q1b (muuttuja V6) vastauksista puuttuvia tietoja on 3,5 prosenttia (1219/34271). **Huom: kun pudotetaan havainnot joilta SEX tai AGE puuttuu, N = 32823! Tutkippa tätä! On oikea määrä (5.7.2019, kts. treeni2\Data_iso1.R**
,
...
** (23.3.2019) Puuttuvien tietojen rajaava vaikutus raportoidaan, kun tietoja rajataan. Ei pohdita tämän enempää**
