...
# 840 US-United States - jätetään pois, jotta saadaan TOPBOT (top-bottom self-placement) -muuttuja mukaan.(10.10.18)
#
...
# Espajana pois (724 ES-Spain)  - Unkari (348) toistaiseksi mukana, mutta joissain kysymyksissä myös Unkarilla on 
# poikkeavia vastausvaihtoehtoja(HU_V18, HU_V19,HU_V20). 
...
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V5, type = "row_perc")
#ISSP2012jh1b.data %>% tableX(C_ALPHAN, V6, type = "row_perc") on jo ylempänä
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V7, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V8, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V9, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V10, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, V11, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, SEX, type = "row_perc")
missAGE <- ISSP2012jh1b.data %>% tableX(C_ALPHAN, AGE, type = "row_perc")
missAGE[,86:87]
ISSP2012jh1b.data %>% tableX(C_ALPHAN, DEGREE, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, MAINSTAT, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, HHCHILDR, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, MARITAL, type = "row_perc")
ISSP2012jh1b.data %>% tableX(C_ALPHAN, URBRURAL, type = "row_perc")
