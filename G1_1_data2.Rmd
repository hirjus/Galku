...
#
#
attributes(ISSP2012jh1.data$V6,'labels')
```
...
attributes(ISSP2012jh1.data, 'notes')
attributes(ISSP2012jh1.data, 'names')
...
**TODO** Pois "perhe-, puoliso- yms." muuttujat
...
#maakoodit ja maan kahden merkin tunnus
countryvars1 <- c("V3","V4","C_ALPHAN")
#temp <- select(ISSP2012jh1.data, metavars1)

#str(temp)

# substanssimuuttujat - Attitudes towards family and gender roles
#
...
# muista puuttuvan tiedon koodeista. Jäteään siis pois.

substvars1 <- c("V5", "V6","V7","V8","V9","V10","V11","V12","V13","V14","V15","V16",
  "V17","V18","HU_V18","V19","HU_V19","V20","HU_V20","V21","V28","V29","V30","V31","V32","V33",
  "V34", "V35", "V36", "V37", "V38", "V39", "V40", "V41", "V42", "V43", "V44", "V45",
  "V46", "V47", "V48", "V49", "V50", "V51", "V52", "V53", "V54", "V55", "V56", "V57", "V58", "V59",
  "V60", "V61", "V62", "V63", "V64", "V65", "V65a","V66", "V67", "SEX", "BIRTH","AGE", "EDUCYRS"
  )
# Q6/V21 "Ideal number of children for a family" 
# Q7a-Q7f monivalintakysymyksiä lasten vaikutuksesta elämään,V23 - V27
childvars <-c ("V22", "V23","V24","V25","V26","V27")
# demografiset muuttujat
demogvars1 <- c()
# muut taustamuuttujat
othervars1 <- c()
str(metavars1)
jhvars1 <- c(metavars1,substvars1,demogvars1,othervars1)
jhvars1
temp <- select(ISSP2012jh1.data, jhvars1)
str(temp)
```
...
**Puuttuneisuus muuttujassa V6 (kysymys Q1b) (esimerkki):** Tämän voisi siirtää esimerkki-lukuun?


```{r muut1}
temp2 <- ISSP2012jh1.data
                                     
#str(temp2)

temp2$Q1b <- as_factor(temp2$V6 )
temp2$maa <-  as_factor(temp2$C_ALPHAN)
...
Koko aineistossa (valitut 27 maata) kysymyksen Q1b (muuttuja V6) vastauksista puuttuvia tietoja on 3,5 prosenttia (1241/35221).
