...
www.issp.org, www.gesis.org : mistä on kysymys
...
# Espjana pois (724 ES-Spain)  - Unkari (348) toistaiseksi mukana, mutta joissain kysymyksissä myös Unkarilla on poikkeavia #vastausvaihtoehtoja(HU_V18, HU_V19,HU_V20). Jos näitä muuttujia käytetään, on Unkarikin parempi jättää aineistosta pois.
...
#Maakohtaiset muuttujat on aineistossa erotelut maatunnus-etuliitteellä (esimerkiksi ES_V7). Nämä muuttujat voi jättää pois, #niiden arvo muilla mailla on "NA" (puuttuva tieto)
#summary(ISSP2012jh1.data$ES_V5)
#
#V18$label
...
**ISSP2012jh1.data - 27 maata. Turhia muuttujia (=kaikki), mutta valitaan tästä aina analyyseissä käytettävät muuttujat**
...
**zxy** Unkarilla poikkeavat vastausvaihtoehdot kysymyksessä Q5, jos sitä ei käytetä niin olkoon HU mukana!
