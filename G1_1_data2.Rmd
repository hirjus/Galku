...
# määritellä järjestys, toistaiseksi niin ei tehdä (25.9.2018). Muunnetun muuttujan rinnalla säilytetään alkuperäinen, koska SPSS-tiedoston metatiedot ovat siinä.
#       
...
# vastaukset 1,...,5) merkkijonomuuttujiksi. Faktoroiduille muuttujille määritellään eksplisiittisesti
# tasot (levels) ja labelit (nimet, labels).
# 
