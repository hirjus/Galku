...
Ikä (AGE) on kokonaisluku), taustamuuttujissa on monenlaisia koodauksia. Edellisen koodilohkon komennot ovat hyödyksi, kun muunnoksia tehdään, voi tarkistaa miten SPSS-data R-muotoon on muuntunut. haven-paketin read_spss on aika varma (6.12.18).
