...
**TODO 30.1.20** Tarkistukset, varmistukset jne.

**TODO2.2.20** Muunnetaanko muuttujan maa (C_ALPHAN as_factor) järjestys heti
samaksi kuin C_ALPHAN? Nyt tehdään G1_2_johdesim.Rmd:ssä.
...
ISSP2012jh1d.dat$maa %>% fct_count() # miksi ei tulosta mitään? (3.2.2020)
...
attributes(ISSP2012jh1d.dat$maa3) # ei tyhiä levels-arvoja, 45 levels
...
ISSP2012jh1d.dat$maa3 %>% summary() # 25 maata: havaintojen määrä, kaikki jos ei
                                    # ositettu. Poisjätetyissä havaintoja 0.
