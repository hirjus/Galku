...
maagaCA2subset1BEBG <- ca(~maaga + Q1b,ISSP2012esim2.dat, subsetrow = 1:24)
par(cex = 0.5)
...
# Datana maagaTab1 - viimeisinä riveinä maarivit
maagaTab1
maagaCA2sub2 <- ca(maagaTab1[,1:5], subsetrow = 1:24, suprow = 73:74)
par(cex = 0.4)
plot(maagaCA2sub2, map = "rowgreen",
     ...
     arrows = c(FALSE, TRUE),
     main = "Äiti töissä: ikäluokka ja sukupuoli maittain",
     sub = "asymmetrinen(rowgreen) kartta:Belgia ja Bulgaria,osajoukon ca, maapisteet täydentävänä pisteenä "
        )
```
