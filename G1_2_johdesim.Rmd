...
#
# LUETAAN DATA G1_1_data2.Rmd - tiedostossa  -> ISSP2012jh1c.data (df) ja käytetään sitä - tämä "pimennetään" (23.3.2019)
...
Valitaan esimerkin data edellisessä luvussa luodusta R-datasta ISSP2012jh1b.data (df). Ihan yhtä hyvin voisi aina lukea suoraan alkuperäisestä spss-tiedostosta, mutta pidemmässä raportissa tämä on siistimpi tapa (23.3.2019).
...
temp3Q1b <- as_factor(ISSP2012esim1.dat$V6, "values") # vain arvot, toimisko?
str(temp3Q1b)
summary(temp3Q1b)
attributes(temp3Q1b)
...
table(temp4Q1b) # NA-arvoja ei mukaan
str(temp4Q1b)

temp5Q1b <- as_factor(ISSP2012esim1.dat$V6, "values")
