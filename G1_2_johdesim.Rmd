...
# "Väärässä" järjestyksessä oleva maa talteen, olisiko järjestys jossa ovat 
# SPSS-datassa?

# Muutetaan R-faktoriksi tarkempi maa-koodi V3
#
...
# uudet labelit?
ISSP2012esim1.dat <- ISSP2012esim1.dat %>%
        mutate(fct_recode(maa3,
                          ))

# muutetaan R-faktoriksi tarkempi maa-koodi V3/maa3 (3.2.20)
...
# Maiden järjestys kääntää kuvan (1.2.20)
...
plot(simpleCA2, map = "symmetric", mass = c(TRUE,TRUE),
     main = "Lapsi kärsii jos äiti on töissä -symmetrinen kartta ",
     sub = "maa-muuttuja järjestys as_factor(C_ALPAN)")
