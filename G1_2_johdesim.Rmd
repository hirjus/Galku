...
library(scales)
library(reshape2)
#library(printr) #19.5.2018 uusi kokeilu (taulukot, matriisit)
```
...
```{r suhtfrek1}
tau1 <- ISSP2012esim1.dat %>% tableX(maa,V6,type = "cell_perc")
knitr::kable(tau1, digits = 2, caption = "A table produced by printr.")
