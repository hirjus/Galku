...
```{r massPlot1, fig.cap="Massojen vakiointi ja khii2-etäisyys keskiarvosta", fig.asp= 1}
# Tarpeeton - ja ei toimi (3.10.20). Kuva olis kiva, kuitenkin.

# colmass_b.tbl
# str(colmass.tbl)
# plot(colmass.tbl$rowid[1],colmass.tbl$rowid[1])
# hist(colmass.tbl[, 1:5])
```
