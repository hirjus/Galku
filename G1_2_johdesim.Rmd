...
ISSP2012esim1b.dat <- ISSP2012esim1.dat %>%
        mutate(maa2 =
                fct_relevel(maa,
                            "BE",
                            "BG",
...
# Tarkistus
ISSP2012esim1b.dat %>% tableX(maa,maa2, type = "count")
ISSP2012esim1b.dat %>% tableX(maa2,C_ALPHAN, type = "count")

```

Muutetaan R-faktorin "maa" järjestys samanlaiseksi alkuperäisen C_ALPAHN- muuttujan
kanssa. Aluksi testausta varten, ISSP2012esim1b.dat. (1.2.20)
...
# Vaikuttaako maa- muuttujan järjestys? (1.2.20)
simpleCA2 <- ca(~maa2 + Q1b,ISSP2012esim1b.dat)
...
Testaus: maa2, sama järjestys kuin C_ALPHA
```{r g1_2_kuva1test}
...
plot(simpleCA1, map = "symmetric", mass = c(TRUE,TRUE),
     main = "Lapsi kärsii jos äiti on töissä -asymmetrinen kartta - as_factor-järjestys")

plot(simpleCA2, map = "symmetric", mass = c(TRUE,TRUE),
     main = "Lapsi kärsii jos äiti on töissä -asymmetrinen kartta - C_ALPHAN-järjestys (aakkosjärj)")
