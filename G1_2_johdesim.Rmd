...
# Maiden järjestys kääntää kuvan (1.2.20) - esimerkkiä ei jatkossa tarvita (18.2.20)

simpleCA2 <- ca(~maa2 + Q1b,ISSP2012esim1.dat)

# Oikeastaan maiden vertailussa pitäisi niiden massat skaalata yhtä suuriksi
# TYYLIKKÄÄMPI RATKAISU TARVITAAN! (11.2.20). MCA_Day2 - r-skriptistä löytyy (12.2.20)
# johdesim1_rowproc.tab <- as.numeric(taulu3)
# johdesim1_rowproc.tab

# simpleCA3 <- ca(taulu3) taulu3 on chr-tyyppiä, ei toimi
# simpleCA3 <- ca(read) # kuva img-hakemistossa (11.2.20)
#        S	s	?	e	E
