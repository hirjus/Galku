...
```{r esim1data1, eval=FALSE, include=FALSE}
#
# LUETAAN DATA G1_1_data2.Rmd - tiedostossa  -> ISSP2012jh1c.data (df), käytetään sitä (23.3.2019)
...
```{r esim1data2}
# LUETAAN DATA G1_1_data2.Rmd - tiedostossa  -> ISSP2012jh1c.data (df) 
# 23 muuttujaa (9 substanssimuuttujaa, 8 taustamuuttujaa, 3 maa-muuttujaa, 3 metadatamuuttujaa)
# 25 maata.
# Poistettu 146 havaintoa, joilla SEX tai AGE puuttuu
...
ISSP2012esim1.dat <- filter(ISSP2012jh1c.data, V4 %in% countries_esim1)
# str(ISSP2012esim1.dat)
vars_esim1 <- c("C_ALPHAN", "V3", "V4", "V6", "SEX", "AGE") #kolme maamuuttujaa, kysymys Q1b
ISSP2012esim1.dat <- select(ISSP2012esim1.dat, vars_esim1)
# str(ISSP2012esim1.dat) 
# 8557 obs. ennen kuin sexagemissing poistettiin, nyt 8542, 8557-8542 = 15
# summary(ISSP2012esim1.dat)
# ISSP2012esim1.dat %>% tableX(C_ALPHAN, V6, type = "count")

# Poistetaan havainnot joissa puuttuva tieto muuttujassa V6 (Q1b) n = 399
# 8542-399 = 8143

ISSP2012esim1.dat <- filter(ISSP2012esim1.dat, !is.na(V6))
ISSP2012esim1.dat %>% tableX(C_ALPHAN, V6, type = "count")
str(ISSP2012esim1.dat)
...
# kopioitu Data_iso.1.R - skriptiin (11.1.2019), jatketaan NA-vääntöä siellä. (23.3.2019)
# 
# Hyödyllistä katsoa, miten as_factor - funkitolla labelit kulkevat mukana! Ja levels on "väärin"!
#
# forcats - paketin as_factor-funktio - haven-paketissa (7.12.2018)
...
temp1Q1b <- as_factor(ISSP2012esim1.dat$V6)
#table(temp1Q1b, exclude=NULL) #otetaan NA-arvot mukaan
table(temp1Q1b) # NA-arvoja ei mukaan
str(temp1Q1b)
summary(temp1Q1b)
attributes(temp1Q1b)
...
table(temp2Q1b) # NA-arvoja ei mukaan
head(temp2Q1b)
attributes(temp2Q1b)
levels(temp2Q1b)


temp3Q1b <- as_factor(ISSP2012esim1.dat$V6, "values") # vain arvot, toimisko? Eipä taida toimia tässä (6.6.2019)
str(temp3Q1b)
summary(temp3Q1b)
attributes(temp3Q1b)
table(temp3Q1b, exclude=NULL) #otetaan NA-arvot mukaan
table(temp3Q1b) # NA-arvoja ei mukaan

ISSP2012esim1.dat$temp4Q1b <- as_factor(ISSP2012esim1.dat$V6, "labels")
str(ISSP2012esim1.dat$temp4Q1b)
summary(ISSP2012esim1.dat$temp4Q1b)
attributes(ISSP2012esim1.dat$temp4Q1b)
table(ISSP2012esim1.dat$temp4Q1b, exclude=NULL) #otetaan NA-arvot mukaan
table(ISSP2012esim1.dat$temp4Q1b) # NA-arvoja ei mukaan
levels(ISSP2012esim1.dat$temp4Q1b)
names(ISSP2012esim1.dat$temp4Q1b)
str(ISSP2012esim1.dat)
#TARKISTUKSET: summary ja levels
# HUOM! Puuttuvat tiedot filtteröity pois, joten otetaan vain faktorit 1-5
...
levels(ISSP2012esim1.dat$Q1b)
str(ISSP2012esim1.dat$sp)
levels(ISSP2012esim1.dat$sp)
#
...
```{r esim1data3}
# poistetaan havainnot, joissa puuttuvia tietoja
# taulukko on sekaisin (28.12.18) - pitäisikö lisätä !is.na(Q1b)?
# V6 haven_labelled num, Q1b factor 8 levels
