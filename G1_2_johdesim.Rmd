...
**zxy**(teoria/historia-jaksoon,104.20).Termi korrespondenssi: "neglected multivariate method" - paperissa käännetty näin englanniksi ransk. termi (Benzecri) rivien ja sarakkeiden
...
**TODO 2.2.20 ** Massat saa mukaan vaikka viittaamalla frekvenssitauluun jos ne
haluaa esittää esim. taulukkona(4.9.2018).


```{r g1-2kuva2, echo=TRUE}
...
**TODO 19.2.20** Siistiksi taulukoksi.
...
```
**TODO**Rivi- ja sarake-etäisyydet (khii2) vaatisivat kommentin.
