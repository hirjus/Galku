...
Dimensioiden vähentämisen idea ("the essence"), joka ei pienessä taulossa ole ihan ilmeinen.
...
**xyz** Perustellaan aineiston valinnan vaiheet. Esimerkiksi otetaan yksi kysymys.
...
**zxy** Ja tätä "triplettiä" täydentää neljä siitä johdettua käsitettä, en nyt (7.8.18) löydä MG-sitaattia.
