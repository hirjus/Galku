...
#näitä kokeiln chunk-optioissa mutta ei toimineet out.width = "6", out.hight = "6" (13.5.2018), vaan pdf-konversiossa #pandoc failed with error 43
```
...
Ja toinen tapa
```{r kuvatdsto1, out.width = "5", fig.asp = 1 }
