...
date: "versio 1.5.5 dev , tulostettu `r Sys.Date()` "
...
**Uusi Galku - 2.2.2020 versio 1.5.5**
...
kuin vanhemmissa versoissa. Korjattu, lisätään johdattelevan esimerkin dataan
myös maakoodi jossa Saksan ja Belgian jako (V3). (**TODO 3.2.20**)
...
***
```{r child = "G1_4_CAlaaj1.Rmd",eval = FALSE}

```

***
```{r child = "G1_5_CAlaaj1.Rmd",eval = FALSE}
