...
date: "versio 1.4, tulostettu `r Sys.Date()` "
...
output:
  ...
  html_document:
    ...
    code_folding: hide
---
Kommentteja ja versionhallintaa, hstoriaa:
...
Data-jaksosta siirretään aineiston laajentamisen yhteyteen laajemman muuttujajoukon deskriptiiviset tarkastelu. Taulukko muuttujakuvauksesta jää data-lukuun.

**Muistilista:** (historiaa)
