...
# Täydäntävät sarakkeet, koko aineisto
 ...
 QjaMuut1.mca <- mjca(mcaDat21jh.dat[,1:12], ps = "",
               supcol = 8:12,
               main = "Kysymykset Q1a-Q1e ja Q2a-Q2b, viisi täydentävää muuttujaa",
               sub = "Täydentävät muuttujat E, S, U, maa, gaf")
# QjaMuut1.mca
...
# eikä toimi tämä
subQjaMuut1.mca <- mjca(mcaDat21jh.dat[, 1:12], ps="",
                        subsetcat=(1:67)[-c(6,12,18,24,30,36,42,50,61,67)],
                        )


#str(subConcat1jh.CA1)
