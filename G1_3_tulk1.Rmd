...
plot(simpleCA1, map = "rowgreen",
     ...
     mass = c(TRUE,TRUE),
     arrows = c(FALSE, TRUE),
     main = "Lapsi kärsii jos äiti on töissä - asymmetrinen kartta 2 (rowgreen)",
     sub = "sarakevektorin värin tummuus = kontribuutio")
...
CA-funktiolle on annettu dataksi riviprofiilit, joiden summat ovat ykkösiä.

**TODO** (21.2.20)

Tätä voisi käyttää esimerkkinä numeeristen tulosten vertailussa?

Huomioita: kokonaisinertia kasvaa (0,18 -> 0,26), koordinaatisto muuttuu mutta ei
kovin radikaalisti. 
Kvaliteetti, kontribuutiot?
