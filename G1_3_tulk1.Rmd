...
oleelliset yhteydet, mutta mielellään vain ne.**todo 10.10.20** Inertian maksimi on ratkaisun dimensioiden
suurin lukumäärä. Tämä teoria-jaksossa.
...
**todo** Tässä "kaikki on suhteellista", Tanskan riviprofiilissa E-vastauksien suhteellinen osuus 
on suurempi kuin koko aineiston keskiarvopisteessä origossa. 
