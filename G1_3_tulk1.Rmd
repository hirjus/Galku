...
Rivipisteet voidaan projisoida ortogonaalisesti (ns. suora kulma) sarakevektorille
...
Toisessa kuvassa sama E-vektorille. Maiden suhteellinen järjestys on oikea, mutta
jos vertaa taulkkoon X (edellä), huomaa että absoluuttiset erot eivät täsmällisesti
toistu kuvassa.

**todo 15.9.20** Voiko tämän tehdä myös skaalatulle (rowgreen) asymmetriselle kuvalle?


```{r G1_3_asymmtulk1, out.width='100%', fig.align='center',fig.cap='Asymmetrinen kuva - sarakevektorin tulkinta 1'}

knitr::include_graphics('img/simpleCAasymmTulk1.png')

```

```{r G1_3_asymmtulk2, out.width='100%', fig.align='center',fig.cap='Asymmetrinen kuva - sarakevektorin tulkinta 2'}
