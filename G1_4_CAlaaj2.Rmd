# Korrespondenssianalyysin laajennuksia 2: vuorovaikutusmuuttuja ja osajoukon CA
...
plot(spCAmaaga1, map = "rowgreen", 
        ...
        mass = c(TRUE,TRUE),
        arrows = c(FALSE,TRUE), 
        main = "Äiti töissä: ikäluokka ja sukupuoli maittain 3 (kontribuutiot)",
                sub = "cex=0.5"
                  )

#
#asymmetrinen kartta - testataan subset-analyysiä (14.8.20)
...
plot(spCAmaaga1, xlim = c(-0.75,0.50), ylim = c(-0.75,0.50),
...
```
Tuo ei oikein toimi, eikä tämäkään (9.9.20), kuvasuhde taitaa olla väärä?

```{r maagaCA2zoom2,fig.cap = "Ikä-sukupuoli-maa",out.width = "90%",fig.align = "center"}
# Zoomaus - esimerkki (24.2.20) xlim=c(-0.5,0.5), ylim=c(-0.6,0.4)
# EI TOIMI - PISTEET piirrettävä, ei voi käyttää ca.plot - funktiota? (4.5.20).
# MG2017 laskarit - day3: mca:n tuloslistaa käytetty luottamusellipseissä ja toimii?
# Piirtää pisteitä koko "plot-alueelle"?
