...
**edit:** Tässä on kehiteltävää, mainittava ainakin dimensioden vähentäminen CA:n ja muiden vastaavien menetelmien ydintavoitteena ("the essence"). 
...
Haaste: käsitteet ja niiden suhteet ovat abstraktien matemaattisten rakenteiden tuloksia (barycentric, sentroidi), ja ne pitää jotenkin johdonmukaisesti pala kerrallaan tuoda esimerkkien kautta tekstiin. Teen käsiteluettelon, ja kirjoitan kaavat yms. toistaiseksi omaan dokumenttiin (LaTeX).
...
taulu1a <- taulu1[ ,1:14]
kable(taulu1a,digits = 2, caption = "Kysymyksen V6 vastaukset maittain")
taulu1b <- taulu1[ ,15:28]
kable(taulu1b,digits = 2, caption = "Kysymyksen V6 vastaukset maittain")
```
